...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2017 at 12:09 PM
...
CREATE TABLE `orders` (
  ...
  `sakhi_id` int(255) NOT NULL DEFAULT '0',
...
CREATE TABLE `sakhi` (
  ...
  `name` text NOT NULL,
  `pickup location` varchar(255) NOT NULL,
  `mobile_number` int(10) NOT NULL,
  `email_id` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `sakhi_preference` tinyint(1) NOT NULL,
  `sakhi_status` tinyint(1) NOT NULL,
  `location_lang` double NOT NULL,
  `location_long` double NOT NULL,
