...
public class RegistrationApi extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String data = URLEncoder.encode("name", "UTF-8") + "=" + URLEncoder.encode("", "UTF-8") + "&" +
                        URLEncoder.encode("email", "UTF-8") + "=" + URLEncoder.encode(params[0], "UTF-8") + "&" +
                        ...
                        URLEncoder.encode("phone", "UTF-8") + "=" + URLEncoder.encode("7182", "UTF-8") + "&" +
                        URLEncoder.encode("online", "UTF-8") + "=" + URLEncoder.encode("1", "UTF-8");
